...
import {
  ...
  getProductById,
  getProducts,
  updateDeliveryMethodByAccountId,
  updateProduct,
} from './controller';
import {
  ...
  updateDeliveryMethodByAccountIdValidation,
...
router.get(
  '/list/all',
  isPermitted([Permissions.PRODUCT_READ]),
  getProductsValidation,
  getAllProducts,
);
...
router.post(
  '/bulk',
  isPermitted([Permissions.PRODUCT_CREATE]),
  createProductsValidation,
  createProducts,
);
...
router.patch(
  '/:id',
  isPermitted([Permissions.PRODUCT_UPDATE]),
  updateProductValidation,
  updateProduct,
);
router.patch(
  '/deliveryMethod/:accountId',
  isPermitted([Permissions.PRODUCT_UPDATE]),
  updateDeliveryMethodByAccountIdValidation,
  updateDeliveryMethodByAccountId,
);
...
router.delete(
  '/',
  isPermitted([Permissions.PRODUCT_DELETE]),
  deleteProductsValidation,
  deleteProducts,
);
